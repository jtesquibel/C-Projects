...
static const char qt_meta_stringdata_LoginWindow[] = {
    "LoginWindow\0\0checkLogin()\0openMainWindow()\0"
    "openNewUserWindow()\0falseUsername(std::string)\0"
    "incorrectPW(std::string)\0"
};
...
void LoginWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->openMainWindow(); break;
        case 2: _t->openNewUserWindow(); break;
        case 3: _t->falseUsername((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        case 4: _t->incorrectPW((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        default: ;
        }
    }
}
